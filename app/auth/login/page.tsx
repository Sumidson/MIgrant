        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-blue-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      {userType ? (
                        <>
                          {userType === 'admin' ? (
                            <UserCog className="h-5 w-5 mr-3 text-blue-600" />
                          ) : (
                        ...
                        >
                          <div className="flex items-center">
                            <Icon className={`h-5 w-5 mr-3 ${
                              option.value === 'admin' ? 'text-blue-600' : 'text-emerald-600'
                            }`} />
                            <div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl py-3 font-semibold hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center"
            >
              {isLoading ? (
                <div className="flex items-center">
