          ...
          <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-xl border border-slate-200 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative z-20">
                  <button
                    ...
                    className={`w-full bg-white border-2 rounded-2xl px-4 py-3 text-left focus:outline-none focus:ring-2 focus:ring-slate-600 focus:border-slate-600 transition-all ${
                      userType 
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        {userType ? (
                          <>
                            {userType === 'admin' ? (
                              <UserCog className="h-5 w-5 mr-3 text-slate-700" />
                            ) : (
                      ...
                      {userOptions.map((option) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full px-4 py-3 text-left hover:bg-slate-50 transition-colors first:rounded-t-2xl last:rounded-b-2xl ${
                              userType === option.value ? 'bg-slate-50' : ''
                            }`}
                          >
                            <div className="flex items-center">
                              <Icon className={`h-5 w-5 mr-3 ${
                                option.value === 'admin' ? 'text-slate-700' : 'text-emerald-600'
                              }`} />
                              <div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border-2 border-slate-200 rounded-2xl pl-12 pr-12 py-3 focus:outline-none focus:ring-2 focus:ring-slate-600 focus:border-slate-600 transition-all"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-slate-700 to-stone-700 text-white rounded-2xl py-3 font-semibold hover:from-slate-800 hover:to-stone-800 focus:outline-none focus:ring-2 focus:ring-slate-600 focus:ring-offset-2 transition-all shadow-md hover:shadow-lg transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center"
              >
                {isLoading ? (
                  <div className="flex items-center">
