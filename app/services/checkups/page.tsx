    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">Comprehensive health analysis and recommendations</p>
              </div>
            </div>
          ...
          {/* Patient Information */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
            <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">{patientInfo.age} / {patientInfo.gender}</p>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">{patientInfo.patientId}</p>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">{patientInfo.reportDate}</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        {/* Navigation Tabs */}
        <motion.div variants={itemVariants} className="bg-white rounded-lg shadow-lg mb-6">
        ...
        <motion.div variants={itemVariants}>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {vitalSigns.map((vital, index) => (
                  ...
                  >
                    ...
                    <h3 className="font-semibold text-gray-800 mb-2">{vital.name}</h3>
                    <div className="flex items-baseline">
                      <span className="text-2xl font-bold text-gray-900">{vital.value}</span>
                      <span className="ml-2 text-sm text-gray-600">{vital.unit}</span>
                    </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    ...
                    <p className="font-semibold text-green-800">Overall Health</p>
                  ...
                  <div className="text-center p-4 bg-orange-50 rounded-lg">
                    ...
                    <p className="font-semibold text-orange-800">Areas to Monitor</p>
                    <p className="text-sm text-orange-600">1 metric elevated</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <Calendar className="w-12 h-12 text-blue-600 mx-auto mb-2" />
                    <p className="font-semibold text-blue-800">Next Checkup</p>
                    <p className="text-sm text-blue-600">In 3 months</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'vitals' && (
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-6">Vital Signs History</h3>
              <div className="space-y-6">
                {vitalSigns.map((vital, index) => (
                  <motion.div
                    key={vital.name}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-800">{vital.name}</h4>
                          <p className="text-sm text-gray-600">Normal range: {vital.normalRange}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="flex items-center">
                          <span className="text-2xl font-bold text-gray-900 mr-2">{vital.value}</span>
                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        {category.tests.map((test, testIndex) => (
                          ...
                          >
                            <td className="py-3 px-4 font-medium text-gray-800">{test.name}</td>
                            <td className="py-3 px-4">
                              <span className="font-semibold text-gray-900">{test.value}</span>
                              <span className="ml-1 text-gray-600">{test.unit}</span>
                            </td>
                            <td className="py-3 px-4 text-gray-600">{test.normalRange}</td>
                            <td className="py-3 px-4">
          ...
          {activeTab === 'recommendations' && (
            <div className="space-y-6">
              ...
              >
                <h4 className="font-bold text-gray-800 mb-2">Doctor&apos;s Note</h4>
